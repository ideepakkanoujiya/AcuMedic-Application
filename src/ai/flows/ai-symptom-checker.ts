...
const AISymptomCheckerInputSchema = z.object({
  ...
  image: z
    ...
    .optional()
    .describe(
      'An optional image related to the symptoms, as a data URI that must include a MIME type and use Base64 encoding. Expected format: \'data:<mimetype>;base64,<encoded_data>\'.' /* e.g., a photo of a rash */
    ),
});
