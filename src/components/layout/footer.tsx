        ...
        <div className="grid gap-12 md:grid-cols-3">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:col-span-2 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><Link href="/doctor/dashboard" className="text-muted-foreground hover:text-foreground transition-colors">Doctor Portal</Link></li>
                <li><Link href="/join" className="text-muted-foreground hover:text-foreground transition-colors">Join Network</Link></li>
              </ul>
            </div>
            <div>
